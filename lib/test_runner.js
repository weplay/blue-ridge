...
if(BlueRidge.loaded != true) {
  ...
  var require = require || function(url, options){ return BlueRidge.CommandLine.require(url, options) };
  var debug   = debug   || function(message)     { return BlueRidge.CommandLine.debug(message) };
