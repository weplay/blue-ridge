...
if(BlueRidge.loaded != true) {
  // Set this in your html fixture file to a lower depth if using nested test directories.
  BlueRidge.depth = BlueRidge.depth || 1; 
  
  var require = require || function(url, options){ return BlueRidge.Browser.require(url, options) };
  var debug   = debug   || function(message)     { return BlueRidge.Browser.debug(message) };
